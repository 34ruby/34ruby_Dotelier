    ...
    <div class="flex-none">
        <div class="dropdown">
            ...
            <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-neutral rounded-box w-52">
              <li><a href="{{ route('dashboard') }}">파레트</a></li>
              <li><a href="{{ route('photos.index') }}">갤러리</a></li>
              <li><a>문의</a></li>
            </ul>
          </div>
    </div>
    <div class="flex-1">
      <a class="btn btn-ghost normal-case text-xl" href="{{ route('dashboard') }}">Dotelier</a>
    </div>
      ...
      <x-dropdown align="right" width="48">
        <x-slot name="trigger">
            <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                <div class="text-neutral-content text-xl">{{ Auth::user()->name }}</div>
